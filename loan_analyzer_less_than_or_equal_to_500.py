...
First, let's start with some calculations on a list of prices for 5 loans.
    1. Use the `len` function to calculate the total number of loans in the list. X
    2. Use the `sum` function to calculate the total of all loans in the list. X
    3. Using the sum of all loans and the total number of loans, calculate the average loan price. X
...
print(f"The average loan amount is: ${int(average_loan_amount)}\n")
...
count = len(inexpensive_loans)
index = 0
print(f"There are {count} loans <= $500\n")
while index < count:
    print(f"Inexpensive loan number {index + 1} is: {inexpensive_loans[index]}\n")
    index = index + 1
...
csvpath = Path("inexpensive_loans_less_than_or_equal_to_500.csv")
...
print(f"---------------- PART 5 ----------------\n")
print(f"Writing inexpensive loans to inexpensive_loans.csv...\n")
print(f"----------------------------------------")